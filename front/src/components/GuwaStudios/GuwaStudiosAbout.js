        ...
        <div id = "nova-stella-about" className="row summer">
            <div className = "col-12">
				...
				<div className = "text-container nova-container-img-sm d-block d-sm-block d-md-none">
					...
					<Link to="/GuwaStudios/talent"><button className = "btn btn-main btn-main-sm">Talent</button></Link>
				</div>
				<div className = "text-container nova-container-img-md d-none d-md-block d-lg-none">
					...
					<Link to="/GuwaStudios/talent"><button className = "btn btn-main btn-main-md">Talent</button></Link>
				</div>					
				<div className = "text-container nova-container-img-lg d-none d-sm-none d-md-none d-lg-block">
					...
					<Link to="/GuwaStudios/talent"><button className = "btn btn-main btn-main-lg">Talent</button></Link>
				</div>
			</div>
        </div>
	);
...
export default GuwaStudiosAbout